...
\usepackage{pgfplots} % needed for graphs (added by Garrett 7.24) 
\usepackage{verbatim} % needed to comment out ^ that stuff
\begin{document}
...
\title{Comparison of file formats for distributing high-energy physics data for outreach efforts}
...
\begin{abstract}
This article compares and contrasts file formats for use in distributing 
high-energy physics (HEP) data for outreach efforts in high schools
and colleges/universities not necessarily involved with the experiments.
The criteria used for comparison are file size, access speed, and 
code maintainence. We find...
\end{abstract}
...
\section{Usage tests \label{sec:usage_tests}} 
\input{usage_tests}
